...
class NombresLamina extends JPanel {
    ...
    NombresLamina() {
        ...
        JButton menuR = new JButton("Reiniciar");
        ...
        mitexto = new JTextField(15);
        mitexto2 = new JTextField(15);
        ...
        miboton1.addActionListener((ActionEvent e) -> {
            ...
            try {
                ...
                texto3.setText("No hay alumnos registrados");
            }
        });
        miboton2.addActionListener((ActionEvent e) -> {
            ...
            for (String string : listNombres) {
                ...
                if (!verd) {
                    textprom.setText("inexiste o vasio");
                }
            }
        });
        textnom.addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {
            }
    ...
    private void agregar() {
        try {
            ...
            mitexto2.setText("");
            texto3.setText("Coloca un valor númerico entero");
        }
    }
