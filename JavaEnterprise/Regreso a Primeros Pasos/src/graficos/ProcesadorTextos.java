...
class LaminaProcesadorTextos extends JPanel {
	...
	public LaminaProcesadorTextos() {
		...
		configuraMenu("Negrita", "estilo", "", Font.BOLD, 1, "bin/graficos/negrita.png", KeyEvent.VK_N);
		configuraMenu("Cursiva", "estilo", "", Font.ITALIC, 1, "bin/graficos/cursiva.png", KeyEvent.VK_K);
		configuraMenu("Subrayado", "estilo", "", 9, 1, "bin/graficos/subra.png", KeyEvent.VK_S);

//		JCheckBoxMenuItem negrita = new JCheckBoxMenuItem("Negrita", new ImageIcon("bin/graficos/negrita.png"));
//		JCheckBoxMenuItem cursiva = new JCheckBoxMenuItem("Cursica", new ImageIcon("bin/graficos/cursiva.png"));
...
//		configuraMenu("20", "tamano", "", 9, 20,"");
		...
		JMenuItem negritaE = new JMenuItem("Negrita", new ImageIcon("bin/graficos/negrita.png"));
		JMenuItem cursivaE = new JMenuItem("Cursiva", new ImageIcon("bin/graficos/cursiva.png"));
		JMenuItem subraE = new JMenuItem("Subrayado", new ImageIcon("bin/graficos/subra.png"));
		...
		configuraBarra("bin/graficos/subra.png").addActionListener(new StyledEditorKit.UnderlineAction());
		barras.addSeparator();
		configuraBarra("src/graficos/azul.gif").addActionListener(new StyledEditorKit.ForegroundAction("", Color.blue));
		configuraBarra("src/graficos/rojo.gif").addActionListener(new StyledEditorKit.ForegroundAction("", Color.red));
		configuraBarra("bin/graficos/Amarillo.png")
				.addActionListener(new StyledEditorKit.ForegroundAction("", Color.yellow));
		configuraBarra("bin/graficos/negro.png")
				.addActionListener(new StyledEditorKit.ForegroundAction("", Color.black));
		barras.addSeparator();
		configuraBarra("bin/graficos/izqui.png").addActionListener(new StyledEditorKit.AlignmentAction("", 0));
		configuraBarra("bin/graficos/centro.png").addActionListener(new StyledEditorKit.AlignmentAction("", 1));
		configuraBarra("bin/graficos/dere.png").addActionListener(new StyledEditorKit.AlignmentAction("", 2));
		configuraBarra("bin/graficos/justi.png").addActionListener(new StyledEditorKit.AlignmentAction("", 3));
